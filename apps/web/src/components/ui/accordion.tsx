/**
 * shadcn/ui Accordion — source: ui.shadcn.com/r/styles/new-york-v4/accordion.json
 * Adapted: `cn` alias → @/lib/utils, `radix-ui` → @radix-ui/react-accordion.
 * Requires --animate-accordion-down/up keyframes in index.css.
 */
